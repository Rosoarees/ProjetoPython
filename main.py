...
# Verifica se é divisão exata
if qntd_az.is_integer():
    print(f"A quantidade exata de azulejos é de {int(qntd_az)}")
else:
    print(f"A quantidade mínima de azulejos é de {math.ceil(qntd_az)}")